...
from pose.model0604 import MoCoPE
...
parser.add_argument('--cnn_model_type', default='base', type=str, help='convnext v2 kind')
parser.add_argument('--train_type', default='mkpts+cnn', type=str, help='net train mode')
