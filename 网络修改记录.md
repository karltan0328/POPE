...
self.mlp = nn.Sequential(
    nn.Linear(in_features=num_sample * 2 * self.pts_size * (2 * self.N_freqs + 1),
              out_features=num_sample * 2 * self.pts_size),
    nn.LeakyReLU(),
    nn.Linear(in_features=num_sample * 2 * self.pts_size,
...
onepose_plusplus-relative_r-gt_t-6d-300-2024-03-14-17-11-53-0.1597.pth
...
onepose_plusplus-relative_r-gt_t-6d-300-2024-03-15-16-21-04-0.2362.pth
...
onepose_plusplus-relative_r-gt_t-6d-300-2024-03-15-17-02-56-0.2351.pth
...
onepose_plusplus-relative_r-gt_t-6d-300-2024-03-15-19-39-10-0.2671.pth
...
onepose_plusplus-relative_r-gt_t-6d-300-2024-03-16-20-15-52-0.1319.pth
...
class Mkpts_Reg_Model(nn.Module):
    ...
    def forward(self,
        ...
        pred_trans_mkpts = self.translation_head(x_mkpts)
        pred_rot_mkpts = self.convert2matrix(self.rotation_head(x_mkpts))

        pred_trans_img = self.translation_head(x_img)
        pred_rot_img = self.convert2matrix(self.rotation_head(x_img))
...
onepose_plusplus-relative_r-gt_t-6d-300-2024-04-08-03-51-48-0.1695.pth
...
onepose_plusplus-relative_r-gt_t-6d-300-2024-04-08-15-06-56-0.0259.pth
